...
<body>
	<nav class="navbar navbar-light bg-#81DAF5"
		...
		<ul class="nav justify-content-end">
			<li class="nav-item"><a class="nav-link" href="#">${member.id } 님 </a></li>
			<li class="nav-item">
	...
	<div class="container">
				...
				<div class="col-md-auto">
					<div class="row">
						<div class="col-md-auto" style="padding-right: 10px">
							<a type="button"
								href="likedPost.do?seq=${post.seq}&&id=${post.writer}"> <img
								class="mb-4"
						...
						<div class="col-md-auto btn-group btn-sm" role="group"
							...
							<c:if test="${member.id == post.writer}">
								<button class="btn btn-outline-secondary" type="button"
									onclick="location.href='modifyPost.do?seq=${post.seq}'">수정</button>
								<button class="btn btn-outline-secondary" type="button"
									onclick="location.href='deletePost.do?seq=${post.seq}'">삭제</button>
							</c:if>
							<button class="btn btn-outline-secondary" type="button"
		...
		<div style='background-color: #E0F2F7'>
			<hr style='height: 1px; background-color: #81DAF5'>
			<form
				action="insertComment.do?seq=${post.seq }"
				method="post">
