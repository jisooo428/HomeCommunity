			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="getPostList.do">전체 글</a></li>
					<li class="nav-item"><a class="nav-link" href="getPostListCate.do?cateSeq=1">추천 맛집/카페</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="getPostListCate.do?cateSeq=2">추천 장소</a></li>
					<li class="nav-item"><a class="nav-link" href="getPostListCate.do?cateSeq=3">소모임/동아리</a></li>
					<li class="nav-item"><a class="nav-link" href="getPostListCate.do?cateSeq=4">정보공유</a></li>
					<li class="nav-item"><a class="nav-link" href="getPostListCate.do?cateSeq=5">아나바다</a></li>
				</ul>
			</div>

			<ul class="nav justify-content-end">
				<li class="nav-item"><a class="nav-link"
					href="editMember.do">${member.id }님 </a></li>
				<li class="nav-item">
				...
				<table class="table table-hover">
					...
					<c:forEach items="${plist}" var="post">
						<tr align="center">
							<td>${post.rn }</td>
							<th scope="row"><a
								href="getPost.do?seq=${post.seq }">${post.title}</a>
							</th>
							<td>${post.writer}</td>
							<td>${post.liked}</td>
							<td>${post.regDate}</td>
					...
					<div class="col-1 dropdown">
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item"
								href="sortByDate.do?">날짜별(오래된 것부터)</a></li>
							<li><a class="dropdown-item"
								href="sortByLiked.do?">좋아요 수</a></li>
						</ul>
					</div>
					<input class="col-1 btn btn-primary" type="button" value="포스팅"
						onclick="location.href='insertPost.do'" />
				</div>
			</div>
		</div>
