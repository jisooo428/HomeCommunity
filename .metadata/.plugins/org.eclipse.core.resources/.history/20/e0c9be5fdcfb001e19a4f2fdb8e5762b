...
public class MemberDAO {
	...
	public MemberDO checkMember(final String id, final String passwd) {
		ArrayList<MemberDO> mList = getMemberList();
		...
		for (int i = 0; i < mList.size(); i++) {
			...
			if ((id.equals(mListmdo.getId())) && (passwd.equals(mListmdo.getPassword()))) {
				return mListmdo;
